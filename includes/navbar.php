				...
				<div class="col-md-5 pt-5 ">
					<ul class="header-links text-center">
						<?php if (!isset($_SESSION['c_email'])) : ?>
							...
							<li><a href="customer/my_account.php?my_orders"><button type="button" class="btn header-button" data-toggle="tooltip" data-placement="top" title="Account">
										<i class="fa fa-user"></i>
									</button></a></li>
							<li><a href="customer_register.php"><button type="button" class="btn header-button" data-toggle="tooltip" data-placement="top" title="Register">
										<i class="fa fa-user-plus"></i>
									</button></a></li>
							<li><a href="login.php"><button type="button" class="btn header-button" data-toggle="tooltip" data-placement="top" title="Login">
							...
							<div class="collapse navbar-collapse" id="navbarNav">
								<ul class="main-nav nav navbar-nav">
									<?php if (!isset($_SESSION['c_email'])) : ?>
										...
										<li class="nav-item"><i class="header-icons fas fa-home"></i><a class="<?php if ($page_title == 'Home - Kasi Mall Online') {
																									echo "active";
